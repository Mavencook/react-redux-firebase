/*! react-redux-firebase.js v2.2.0-alpha.2 */
...
var _filter2 = __webpack_require__(112);
...
var _mapValues2 = __webpack_require__(115);
...
var baseGetAllKeys = __webpack_require__(94),
    getSymbolsIn = __webpack_require__(122),
...
var identity = __webpack_require__(25),
    metaMap = __webpack_require__(133);
...
var metaMap = __webpack_require__(133),
...
var _query = __webpack_require__(113);
...
var _createFirebaseInstance = __webpack_require__(85);
...
var _flatMap2 = __webpack_require__(206);
...
var baseIteratee = __webpack_require__(7),
    basePullAt = __webpack_require__(204);
...
var _omit2 = __webpack_require__(119);
...
var createWrap = __webpack_require__(80);
...
function writeMetadataToDb(_ref3) {
  ...
  return getDownloadURLFromUploadTaskSnapshot(uploadTaskSnapshot).then(function (downloadURL) {
    ...
    var metaSetPromise = function metaSetPromise(fileData) {
      return useFirestoreForStorageMeta ? firebase.firestore().collection(dbPath).add(fileData) : firebase.database().ref(dbPath).update(fileData).then(function () {
